...
import tb_client.models
from tb_client import rest
from tb_client.api_response import ApiResponse
from tb_client.api_response import T as ApiResponseT
from tb_client.configuration import Configuration
from tb_client.exceptions import (
    ApiException,
    ApiValueError,
)
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(tb_client.models, klass)
